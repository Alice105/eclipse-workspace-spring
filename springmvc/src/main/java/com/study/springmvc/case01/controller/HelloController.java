...
public class HelloController {
	 ...
	 * 可以使用:Optional<?>來接參數
	 * */
	//請設計方法api,結果會得到bmi=20.76。或資訊不足則顯示 bmi=None!
	@RequestMapping("/bmi")
	@ResponseBody
	...
	public String calcExp(@PathVariable("exp") String exp,
		...
		return String.format("Result: %d %s %d = %d", x,(exp=="add")?"+":"-",y,result);
	}
	
	/*
	 * 6.@PathVariable(萬用字元: * 任意多字、? 任意一字)
	 * 路徑:/any/namejo/java8
	 * 路徑:/any/nameTaipei/java7
	 * 路徑:/any/name1234/java6
	 * */
	...
	/*
	 * 9.pojo(entity)
	 * 有一個User.java裡面有name與age這兩個物件屬性
